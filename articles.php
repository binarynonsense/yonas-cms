...
include_once("include/initarticles.inc.php");
?>
...
<head>
	...
	<?=htmlTitle($webTitle,$articleData['title'])?>
...
<div id="content">
	...
	<div id="center">
		...
		<?php
			...
			echo "<div class='posttitle'>".$articleData['title']."</div>\n";
			echo "<div class='date'>published by ".$userName." on $month/$day/$year at $hour[0]:$hour[1]:$hour[2]</div>\n";
			echo "<div class='text'>".addp($articleData["text"])."</div>\n";
